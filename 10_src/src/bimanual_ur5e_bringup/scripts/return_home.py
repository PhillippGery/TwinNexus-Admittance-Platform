...
# Gripper is commanded by the TwinNexus bridge's go_home handler — not published
# directly here to avoid a double-command race when the arm is already at home.
